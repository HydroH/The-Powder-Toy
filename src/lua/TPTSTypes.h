...
public:
	...
	GeneralException(TEXT_EXCEPT_CONV_1 + format::StringToWString(AnyType::TypeName(from_)) + TEXT_EXCEPT_CONV_2 + format::StringToWString(AnyType::TypeName(to_)) + TEXT_EXCEPT_CONV_3) {
	}
};
