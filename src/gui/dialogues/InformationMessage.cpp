	...
	ui::Window(ui::Point(-1, -1), ui::Point(200, 35))
{
	...
	ui::Button * okayButton = new ui::Button(ui::Point(0, Size.Y-16), ui::Point(Size.X, 16), TEXT_DIALOG_MSG_PROM_BTN_OKAY);
...
InformationMessage::InformationMessage(std::wstring title, std::wstring message, bool large):
