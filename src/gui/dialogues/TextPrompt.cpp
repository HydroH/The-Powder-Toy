	...
	callback(callback_)
{
	...
	ui::Button * cancelButton = new ui::Button(ui::Point(0, Size.Y-16), ui::Point((Size.X/2)+1, 16), TEXT_DIALOG_TEXT_PROM_BTN_CANC);
	...
	ui::Button * okayButton = new ui::Button(ui::Point(Size.X/2, Size.Y-16), ui::Point(Size.X/2, 16), TEXT_DIALOG_TEXT_PROM_BTN_OKAY);
...
TextPrompt::TextPrompt(std::wstring title, std::wstring message, std::wstring text, std::wstring placeholder, bool multiline, TextDialogueCallback * callback_):
	ui::Window(ui::Point(-1, -1), ui::Point(200, 65)),
	callback(callback_)
{
	if(multiline)
...
std::string TextPrompt::Blocking(std::wstring title, std::wstring message, std::wstring text, std::wstring placeholder, bool multiline)
{
	std::string returnString = "";
...
std::wstring TextPrompt::WBlocking(std::string title, std::string message, std::string text, std::string placeholder, bool multiline)
{
	...
	public:
		BlockingTextCallback(std::wstring & output) : outputString(output) {}
		virtual void TextCallback(TextPrompt::DialogueResult result, std::wstring resultText) {
			if(result == ResultOkay)
				outputString = resultText;
			else
				outputString = L"";
...
std::wstring TextPrompt::WBlocking(std::wstring title, std::wstring message, std::wstring text, std::wstring placeholder, bool multiline)
{
	std::wstring returnString = L"";
