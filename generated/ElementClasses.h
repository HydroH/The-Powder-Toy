...
class Element_ADMN: public Element
{
public:
	Element_ADMN();
	virtual ~Element_ADMN();
	
};

class Element_DOOR: public Element
{
public:
	Element_DOOR();
	virtual ~Element_DOOR();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};

class Element_ONC: public Element
{
public:
	Element_ONC();
	virtual ~Element_ONC();
...
class Element_HBMB: public Element
{
public:
	Element_HBMB();
	virtual ~Element_HBMB();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};
